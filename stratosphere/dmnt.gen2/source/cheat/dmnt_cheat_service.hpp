...
#define AMS_DMNT_I_CHEAT_INTERFACE_INTERFACE_INFO(C, H)                                                                                                                                                        \
    ...
    AMS_SF_METHOD_INFO(C, H, 65400, Result, GetGen2WatchData,            (const sf::OutBuffer &buffer),                                                                        (buffer)) \
    AMS_SF_METHOD_INFO(C, H, 65401, Result, SetGen2WatchData,            (const sf::InBuffer &buffer),                                                                         (buffer))
...
namespace ams::dmnt::cheat {
    ...
    class CheatService {
        public:
            ...
            Result GetGen2WatchData(const sf::OutBuffer &buffer);
            Result SetGen2WatchData(const sf::InBuffer &buffer);
    };
